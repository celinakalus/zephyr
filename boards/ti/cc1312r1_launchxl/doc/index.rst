...
The Texas Instruments CC1312R LaunchPad |trade| (LAUNCHXL-CC1312R1) is a
development kit for the SimpleLink |trade| multi-Standard CC1312R wireless MCU.

See the `TI CC1312R LaunchPad Product Page`_ for details.

.. figure:: img/cc1312r1_launchxl.jpg
   :align: center
   :alt: TI CC1312R LaunchPad

   Texas Instruments CC1312R LaunchPad |trade|

Hardware
********

The CC1312R LaunchPad |trade| development kit features the CC1312R wireless MCU.
...
The CC13122 wireless MCU has a 48 MHz Arm |reg| Cortex |reg|-M4F SoC and an
...
The CC1312R LaunchPad board configuration supports the following hardware
features:
...
.. _TI CC1312R LaunchPad Product Page:
   http://www.ti.com/tool/launchxl-cc1312r1

.. _TI CC1312R Product Page:
   http://www.ti.com/product/cc1312r
